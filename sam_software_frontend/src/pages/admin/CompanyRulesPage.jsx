        ...
        <div className="filters-container">
          ...
          <div className="filters-right" style={{ display: "flex", gap: 8 }}>
            ...
            <button
              ...
              onClick={() => (window.location.href = "/admin/add-company-rule")}
            >
                      ...
                      <td>
                        <div className="table-actions">
                          <button
                            ...
                            title="Edit Rule"
                            onClick={() =>
                              (window.location.href = `/admin/update-company-rule?id=${row.id}`)
                            }
                          >
                ...
                {visibleCount === 0 && (
                  <tr>
                    <td colSpan={7} style={{ textAlign: "center", padding: "1.5rem" }}>
                      {loading ? "Loading company rules..." : "No company rules found."}
                    </td>
                  </tr>
                )}
              </tbody>
        ...
        <div className="modal-backdrop" style={backdropStyle}>
          <div style={modalStyle}>
            ...
            <p>
              ...
              <strong>{ruleToDelete?.title}</strong>?
            </p>
